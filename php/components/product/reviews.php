<!--
Detta är HTML-kod för att visa användarrecensioner med bilder, användarnamn, datum och betyg.
Recensionerna är uppdelade i två kolumner för en bättre layout och läsbarhet.
-->
<div class="container">
    <div class="row">
        <div class="col-12">
