<!--
En sidoavsnitt med filtreringsalternativ, inklusive underkategorier, märken, prisintervall, storlek och betyg.
Använder accordion-komponenter för att visa och dölja filtreringsalternativen.
-->
<aside class="col-sm-12 col-md-3 mt-4">
    ...
    <div class="collapse card d-lg-block mb-5" id="accordion-filter">
        <div class="accordion" id="accordionPanelsStayOpenExample">
            ...
            <div class="accordion-item">
                ...
                <div id="content-rating" class="accordion-collapse collapse show rating align-middle">
                    <div class="accordion-body">
                        <!-- Default checkbox -->
                        <div class="form-check">
